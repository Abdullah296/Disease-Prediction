...
totalD1 = list(myData[0:, 0]).count(T1)                    # Total D1 person
totalD2 = list(myData[0:, 0]).count(T2)                    # Total D2 person
...
HaveD1 = myData[myData[:, 0] == T1]                         # Seperate all D1 person attributes
# selecting all rows that contans 2 in class column
# all live
HaveD2 = myData[myData[:, 0] == T2]                         # Seperate all D2 person attributes
...
if(P1>P2):
    Getdisease =[k for k,v in Disease.items() if v == T1]
    print("You are diagonose with ", Getdisease[0])
else:
    Getdisease =[k for k,v in Disease.items() if v == T2]
    print("You are diagonose with ", Getdisease[0])
